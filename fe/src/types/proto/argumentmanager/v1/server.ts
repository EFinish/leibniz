...
/**
 * @generated from protobuf message argumentmanager.v1.HealthCheckRequest
 */
...
/**
 * @generated from protobuf message argumentmanager.v1.HealthCheckResponse
 */
export interface HealthCheckResponse {
    /**
     * @generated from protobuf field: argumentmanager.v1.HealthCheckResponse.ServingStatus status = 1;
     */
    status: HealthCheckResponse_ServingStatus;
}
/**
 * @generated from protobuf enum argumentmanager.v1.HealthCheckResponse.ServingStatus
 */
...
/**
 * @generated from protobuf message argumentmanager.v1.TestRequest
 */
export interface TestRequest {
}
/**
 * @generated from protobuf message argumentmanager.v1.TestResponse
 */
...
class HealthCheckRequest$Type extends MessageType<HealthCheckRequest> {
    constructor() {
        super("argumentmanager.v1.HealthCheckRequest", [
...
/**
 * @generated MessageType for protobuf message argumentmanager.v1.HealthCheckRequest
 */
...
class HealthCheckResponse$Type extends MessageType<HealthCheckResponse> {
    constructor() {
        super("argumentmanager.v1.HealthCheckResponse", [
            { no: 1, name: "status", kind: "enum", T: () => ["argumentmanager.v1.HealthCheckResponse.ServingStatus", HealthCheckResponse_ServingStatus] }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: HealthCheckResponse): HealthCheckResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* argumentmanager.v1.HealthCheckResponse.ServingStatus status */ 1:
    ...
    internalBinaryWrite(message: HealthCheckResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* argumentmanager.v1.HealthCheckResponse.ServingStatus status = 1; */
        if (message.status !== 0)
...
/**
 * @generated MessageType for protobuf message argumentmanager.v1.HealthCheckResponse
 */
export const HealthCheckResponse = new HealthCheckResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TestRequest$Type extends MessageType<TestRequest> {
    constructor() {
        super("argumentmanager.v1.TestRequest", []);
    }
...
/**
 * @generated MessageType for protobuf message argumentmanager.v1.TestRequest
 */
export const TestRequest = new TestRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TestResponse$Type extends MessageType<TestResponse> {
    constructor() {
        super("argumentmanager.v1.TestResponse", []);
    }
...
/**
 * @generated MessageType for protobuf message argumentmanager.v1.TestResponse
 */
export const TestResponse = new TestResponse$Type();
/**
 * @generated ServiceType for protobuf service argumentmanager.v1.ArgumentManager
 */
export const ArgumentManager = new ServiceType("argumentmanager.v1.ArgumentManager", [
